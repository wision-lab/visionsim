...
class BlenderDatasetGenerator:
    ...
    @staticmethod
    def get_camera_intrinsics(mode="complete"):
        # See: https://mcarletti.github.io/articles/blenderintrinsicparams/
    ...
    def generate_views_along_spline(
        ...
        transforms["camera"]["fx"] = 1 / 2 * self.width / np.tan(1 / 2 * self.camera.data.angle_x)
        transforms["camera"]["fy"] = 1 / 2 * self.height / np.tan(1 / 2 * self.camera.data.angle_y)
