...
# visionsim blender.render_animation --blend-file=lego.blend --root-path=quickstart/lego-gt/ --keyframe-multiplier=5.0 --device=metal
# visionsim ffmpeg.animate --input-dir=quickstart/lego-gt/frames --outfile=quickstart/preview.mp4 --step=5 --fps=25 --force
# visionsim interpolate.frames --input-dir=quickstart/lego-gt/ --output-dir=quickstart/lego-interp/ --n=2
