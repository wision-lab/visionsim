...
def pass_if_present(func: Callable) -> Callable:
    """Decorator that passes keyword arguments to a function  only if they were explicitly set on CLI.
...
def add_args_to_signature(*arg_names, replace_kw_only=True, **kwarg_names):
    """Decorator that extends a function's signature by adding new positional or keyword arguments.
    ...
    **kwarg_names,
    ...
    Args:
        *arg_names: Arg names to be added.
        ...
        add_context: Flag to add context argument to function signature.
        ...
        docstring: Docstring. Defaults to none.
